...
public class ProfileServiceImpl implements ProfileService {
	...
	public ProfileResponseDto createProfile(ProfileRequestDto profileRequestDto) throws AgeNotMatchedException {
		...
		if (profileRequestDto != null) {
			...
			int age = Utils.calculateAge(profileRequestDto.getDob());
			String gender = profileRequestDto.getGender();

			if ((gender.equalsIgnoreCase("male") && age <= StringConstant.MIN_MALE_AGE)
					|| (gender.equalsIgnoreCase("female") && age <= StringConstant.MIN_FEMALE_AGE)) {
